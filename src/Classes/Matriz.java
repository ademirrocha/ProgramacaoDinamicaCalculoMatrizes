...
public class Matriz {
    ...
    /*Atributos da classe*/
    /*string: atributo que recebe os dados de saída de printOptmalParents() para poder exibir o resultado da parentização. */
    ...
    private int colunas;
    /*inicoMatriz: atributo tipo flag, para marcar a inicialização de matrizes no método recursiveMatrixChain(int p[], int i, int j)*/
